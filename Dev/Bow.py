...
#RadLTop = visual.RadialStim(winL,size=resY-350, angularCycles=40, color=-1,angularRes=100,units="pix", radialCycles = 0, contrast = 0.8, visibleWedge=[0,40], ori=-110)
#RadLBot = visual.RadialStim(winL,size=resY-350, angularCycles=40, color=-1,angularRes=100,units="pix", radialCycles = 0, contrast = 0.8, visibleWedge=[180,220], ori=-110)
#ConcRTop = visual.RadialStim(winR,size=resY-350,angularCycles=0, color=-1,angularRes=35,units="pix", radialCycles= 16, contrast = 0.8, visibleWedge=[0,40], ori=-105)
#ConcRBot = visual.RadialStim(winR,size=resY-350,angularCycles=0, color=-1,angularRes=35,units="pix", radialCycles= 16, contrast = 0.8, visibleWedge=[180,220], ori=-110)
Left = GratingStim(winL, size=(200,100))
Right = GratingStim(winL, size=(200,100))
# Triggers
#TriggerL
#TriggerR = visual.RadialStim(winR,size=resY-350,angularCycles=0, color=-1,angularRes=35,units="pix", radialCycles = 16, 
...
Fixation = [fixationL, fixationR, dotL, dotR]
