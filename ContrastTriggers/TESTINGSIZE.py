...
RadL = visual.RadialStim(winL,size=532, angularCycles=35, color=-1,angularRes=85,units="pix", radialCycles = 0, contrast = 0.7)
maskL = visual.RadialStim(winL,color=[0,0,0],size=(532)*0.745,angularCycles=25,angularRes=35,units="pix")
ConcR = visual.RadialStim(winR,size=532,angularCycles=0, color=-1,angularRes=35,units="pix", radialCycles= 10, ori=300, contrast = 0.45)
maskR = visual.RadialStim(winR,color=[0,0,0],size=(532)*0.76,angularCycles=25,angularRes=35,units="pix")
...
#Spokes
# to the right window    
BarTop = visual.PatchStim(winR, tex='none', units='pix', rgb=1.0, pos=(0,85),ori=0, size=(15,1))
BarLeft = visual.PatchStim(winR, tex='none', units='pix', rgb=1.0, pos=(-85,0),ori=0, size=(1,15))

# to the left window    
BarBottom = visual.PatchStim(winL, tex='none', units='pix', rgb=-1.0, pos=(-0,-85),ori=0, size=(15,1))
BarRight = visual.PatchStim(winL, tex='none', units='pix', rgb=-1.0, pos=(85,0),ori=0, size=(1,15))
...
# Create trigger with new contrast
    triggerR = visual.RadialStim(winR,size=532,angularCycles=0, color=-1,angularRes=100,units="pix", radialCycles = 8, 
        visibleWedge = (0,20), ori=-10, contrast = y)
